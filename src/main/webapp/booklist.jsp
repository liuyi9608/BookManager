...
<head>
    ...
    <script type="text/javascript" src="j${pageContext.request.contextPath}/static/s/jquery.js"></script>
...
<div class="mianCont">
    ...
    <div class="positions">
        当前位置：<a href="index.index.jsp">首页</a> &gt; <a href="#" class="posCur">促销商品</a>
    </div><!--positions/-->
    <div class="cont">
        <div class="jilu">
            总计 <span>${bookTotal}</span> 个记录
        </div><!--jilu/-->
        <div class="contLeft">
            <ul class="leftPorNav">
